...
/**
 * Horizontally scrollable admin nav. Active link gets a yellow underline +
 * brighter text. The whole strip swipes on touch — important on mobile
 * where 5+ links don't fit in the header.
 */
...
/**
 * Compact burger-the-food icon (32×32) for the admin header. Mirrors the
 * favicon and the mobile public nav so the brand reads consistently.
 */
